...
// // s.innerText = item.surname;
// a.innerText = item.age;
// i.innerText = item.info;
// img.innerText = item.photo;
//
// img.setAttribute('src', item.photo);
// img.setAttribute('alt', item.name)
//
// div.append(h1,s,a,i,img);
...
// зберігатись значення окремих властивостей, для властивості modules зробити список
// з елементами

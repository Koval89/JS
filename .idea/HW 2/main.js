...
// let boocks=[
//     {title:'The Little Prince',pageCount: 100,genre:'story',authors:['A. de Saint-Exupéry']},
//     {title: 'Red sails',pageCount: 70, genre: 'A story extravaganza',authors: ['A. Green']},
//     {title: 'Three musketeers',pageCount: 95,genre: 'novel',authors: ['A. Dumas']}
// ]
// console.log(boocks)
